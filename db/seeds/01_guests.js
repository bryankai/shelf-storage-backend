  ...
  return knex(TABLE_NAME).del()
    .then(function () {
      ...
      return knex(TABLE_NAME).insert([
        {id: 1, first_name: 'Steve', last_name: 'Johnson', email: 'test@gmail.com', hashed_password: '$2a$10$vmSqInKADj2nT7iy2C1z9.uggyjKcodbPgCFYyerIGFHwgyxnnlfe', avatar: 'https://a0.muscache.com/im/pictures/5a78c209-7374-4b2d-a963-b88e32c9a6e1.jpg?aki_policy=profile_x_medium'},
        ...
        {id: 4, first_name: 'Michael', last_name: 'Lopez', email: 'roger@gmail.com', hashed_password: '$2a$10$vmSqInKADj2nT7iy2C1z9.uggyjKcodbPgCFYyerIGFHwgyxnnlfe', avatar: 'https://a0.muscache.com/im/pictures/user/11463f0f-6f47-493a-a515-5e1ce31f925c.jpg?aki_policy=profile_x_medium'},
