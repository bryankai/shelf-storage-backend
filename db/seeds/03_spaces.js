  ...
  return knex(TABLE_NAME).del()
    .then(function () {
      ...
      return knex(TABLE_NAME).insert([
        ...
        {id: 6, name: "Office Space for Storage", description: 'A vacant open office space that can be used for storage.  It is approximately 15x10ft.  Clean and easy access.', img_link: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT06CuoDUIV3awehpajS_WnPoBInPjSrkAKK8STYlOqZ1zCRgYbLA', hosts_id: 1, address: '4106 12th Ave NE', city: 'Seattle', state: 'WA', zip: 98105, lat: 47.657107, lng: -122.315259, temp_control: true, access: false, size: 150, price: 8, active: true, deleted_at: null},
