  ...
  return knex(TABLE_NAME).del()
    .then(function () {
      ...
      return knex(TABLE_NAME).insert([
        {id: 1, name: "Nice basement", description: 'Indoor, temperature controlled space for your precious belongings.  Heating and cooling available.  24/7 access through large metal doors.  Spacious enough for any of your belongings.  Contact host if you have any questiosn.', img_link: 'https://images.unsplash.com/photo-1646592474103-cfd22d1d9e34?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2340&q=80', hosts_id: 1, address: '111 South Jackson Street', city: 'Seattle', state: 'WA', zip: 98104, lat: 47.598976, lng: -122.333787, temp_control: true, access: true, size: 250, price: 10, active: true, deleted_at: null},
        ...
        {id: 10,
          ...
          img_link:  "https://images.unsplash.com/photo-1630699144867-37acec97df5a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2340&q=80",
          hosts_id: 4,
          address: '109 NE 61st St,',
          city: 'Seattle',
          state: 'WA',
